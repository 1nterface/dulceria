                                  ...
                                  children: [
                                    Column(
                                      children: [
                                        ...
                                        SizedBox(
                                            width: 120,
                                            child: Text(document["estado3"], textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.purple[800]),)),
                                        SizedBox(
                                          width: 120,
                                          child: Text(document["concepto"], style: TextStyle(color:Colors.purple[800], fontSize: 15.0)),
                                        ),
                                        SizedBox(
                                          width: 120,
                                    ...
                                    Column(
                                      children: [
                                        Text("\$"+document["totalNota"].toString(), style: TextStyle(color:Colors.purple[800])),
                                        SizedBox(height: 10,),
                                        InkWell(
                                          child: SizedBox(
                                            height: 50,
