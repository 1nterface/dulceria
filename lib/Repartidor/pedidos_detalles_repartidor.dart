                ...
                Row(
                  ...
                  children: <Widget>[
                    Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: <Widget>[
                        Text(widget.product.foto, style: TextStyle(color: Colors.purple[800], fontSize: 30, fontWeight: FontWeight.bold),),
                        ...
                        Row(
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Icon(Icons.copy, color: Colors.purple[800], size: 25,),
                            ),
                        ...
                        InkWell(
                          ...
                          child: Icon(Icons.location_pin, color: Colors.purple[800], size: 25,),
                        ),
                      ],
                    ),
                  ],
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  ...
                  SwipingButton(
                    swipeButtonColor: Colors.purple,
