...
class alta_costos_caja extends StatefulWidget {

  cajas_modelo product;
  alta_costos_caja(this.product);

  @override
  alta_costos_cajaState createState() => alta_costos_cajaState();
}

class alta_costos_cajaState extends State<alta_costos_caja> {
  ...
  FirebaseStorage storage = FirebaseStorage.instanceFor(bucket: "gs://baja-food.appspot.com");
  ...
  Future uploadImageToFirebase(BuildContext context) async {
    ...
    TaskSnapshot taskSnapshot = await uploadTask.whenComplete(() => Navigator.pop(context));//al parecer por esta linea no queria subir, hacer prueba
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Alta Dulces', style: TextStyle(color: Colors.white)),
      ),
      body:
      load == true?
