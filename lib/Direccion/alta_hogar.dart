...
class alta_hogar extends StatefulWidget {

  cajas_modelo product;
  alta_hogar(this.product);

  @override
  alta_hogarState createState() => alta_hogarState();
}

class alta_hogarState extends State<alta_hogar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Alta Hogar', style: TextStyle(color: Colors.brown)),
      ),
      body: Padding(
