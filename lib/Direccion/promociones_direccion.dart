...
class promociones_direccion extends StatefulWidget {

  cajas_modelo product;
  promociones_direccion(this.product);


  @override
  promociones_direccionState createState() => promociones_direccionState();
}

class promociones_direccionState extends State<promociones_direccion> {
  ...
  Widget lista (){
    ...
    return Expanded(
      child: StreamBuilder(
        ...
        //Y ASI  CON TODOS
          stream: reflistaproduccion.where('correoNegocio', isEqualTo: correo).where('categoria', isEqualTo: "Oferta").orderBy('folio', descending: false).snapshots(),
