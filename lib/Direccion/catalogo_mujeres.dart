...
import 'package:dulceria/Direccion/carpinteria_producto_detalle.dart';
import 'package:dulceria/Direccion/pedidos_detalles.dart';
...
class catalogo_mujeres extends StatefulWidget {

  cajas_modelo product;

  final int folio;
  catalogo_mujeres(this.folio, this.product);


  @override
  catalogo_mujeresState createState() => catalogo_mujeresState();
}

class catalogo_mujeresState extends State<catalogo_mujeres> {
  ...
  Widget lista (){
    ...
    return Expanded(
      child: StreamBuilder(
        ...
        //Y ASI  CON TODOS
          stream: reflistaproduccion.where('correoNegocio', isEqualTo: correo).where('categoria', isEqualTo: "Dulces").orderBy('nombreProducto', descending: false).snapshots(),
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                                  Text("\$"+documents["costoProducto"].toString(), style: TextStyle(color: Colors.purple[800], fontSize: 20),),
                                ],
                              ),
                            ],
                          ),
      ...
      floatingActionButton: SpeedDial( //Boton flotante animado
        ...
        children: [
          ...
          SpeedDialChild(
              ...
              backgroundColor: Colors.purple[800],
              label: 'Agregar Dulces',
              onTap: () async {

                await Navigator.push(context, MaterialPageRoute(builder: (context) => alta_costos_caja(cajas_modelo("", widget.product.nombreProducto,"fecha",0,2,3, 0,5,"","Hombres","foto","descripcion", "",0))),);
              }
          ),
          //  SpeedDialChild(
          //  child: Icon(Icons.add, color: Colors.white,),
