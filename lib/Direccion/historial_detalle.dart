...
class historial_detalle extends StatefulWidget {

  cajas_modelo product;
  historial_detalle(this.product);

  @override
  historial_detalleState createState() => historial_detalleState();
}

class historial_detalleState extends State<historial_detalle> {
  ...
  Future<void> pedidos (BuildContext context)async{
    ...
    QuerySnapshot _myDoc2 = await FirebaseFirestore.instance.collection('Pedidos_Jimena').where('correoNegocio', isEqualTo: correoPersonal).where("visto", isEqualTo: "si").get();
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children:[
                              Text('Tu orden', style: TextStyle(color: Colors.purple[800],fontSize: 35, fontWeight: FontWeight.bold)),
                        ...
                        widget.product.estado == null?
                            Container()
                        :
                        Text(widget.product.estado, style: TextStyle(fontSize: 25, color: Colors.black)),
                        Padding(
