...
class postres_sheet extends StatefulWidget {

  int folio;

  postres_sheet(this.folio);

  @override
  _postres_sheetState createState() => _postres_sheetState();
}

class _postres_sheetState extends State<postres_sheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      ...
      //Y ASI  CON TODOS
        stream: reflistacajas.where('correoNegocio', isEqualTo: correoPersonal).where('categoria', isEqualTo: "Otros").orderBy('nombreProducto', descending: false).snapshots(),
