...
class alta_portada extends StatefulWidget {

  @override
  alta_portadaState createState() => alta_portadaState();
}

class alta_portadaState extends State<alta_portada> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Alta Portada', style: TextStyle(color: Colors.white)),
      ),
      body:
      load == true?
