...
import 'package:dulceria/Direccion/carpinteria.dart';
...
class direccion_registro_nuevo extends StatefulWidget {
  ...
  const direccion_registro_nuevo({required Key key, required this.permissionLevel}) : super(key: key);
...
class direccion_registro_nuevoState extends State<direccion_registro_nuevo> {
  ...
  Future _startUploadTask() async {
    ...
    collRef.set({
      ...
      'foto': "http://yucatanbajolalupa.com.mx/wp-content/uploads/2020/03/Logo-Carrusel.jpg",
    });
  ...
  void checkServiceStatusEfectivo(BuildContext context, LocationPermissionLevel permissionLevel) {
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: <Widget>[
                Icon(Icons.location_city, color: Colors.purple[800]),
                SizedBox(width: 15),
                categoria(context),
                //Text('Medidas: 5A'),
              ],
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.arrow_forward, color: Colors.purple[800]),
                SizedBox(width: 15),
                //categorias(context),
              ],
            ),
            ...
            Row(
              ...
              children: const [
                SizedBox(width: 20),
                SizedBox(width: 15),
                Text('Elige tu horario', style: TextStyle(fontSize: 16, color: Color(0XFFA7BCC7))),
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                GestureDetector(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Icon(Icons.more_time, color: Colors.purple[800]),
                      SizedBox(width: 15),
            ...
            Row(
              ...
              children: const [
                SizedBox(width: 20),
                SizedBox(width: 15),
                Text('Elige tus servicios', style: TextStyle(fontSize: 16, color: Color(0XFFA7BCC7))),
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.directions_car_rounded, color: Colors.purple[800]),
                Expanded(
                  child: Column(
                    children: text
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.add_location_sharp, color: Colors.purple[800]),
                Expanded(
                  child: Column(
                    children: text2
                        .map((t) => CheckboxListTile(
            ...
            Row(
              ...
              children: const [
                SizedBox(width: 20),
                SizedBox(width: 15),
                Text('Elige tu tipo de pago', style: TextStyle(fontSize: 16, color: Color(0XFFA7BCC7))),
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.attach_money, color: Colors.purple[800]),
                Expanded(
                  child: Column(
                    children: textefe
                        .map((t) => CheckboxListTile(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.credit_card, color: Colors.purple[800]),
                Expanded(
                  child: Column(
                    children: texttar
                        .map((t) => CheckboxListTile(
          ...
          child: !showShadow
            ...
            onTap: (){
              ...
              if (_formKey.currentState!.validate()) {
                ...
                contra == contrav?
                checkServiceStatusEfectivo(context, widget.permissionLevel)
                    :
