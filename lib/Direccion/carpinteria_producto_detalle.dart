...
import 'package:dulceria/Direccion/gerencia_home_sheet.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter_speed_dial/flutter_speed_dial.dart';
import 'package:dulceria/Direccion/gerencia_home.dart';
import 'package:dulceria/Direccion/gerencia_home_sheet.dart';
import 'package:dulceria/Direccion/producto_detalle2.dart';
import 'package:dulceria/Modelo/cajas_modelo.dart';
import 'package:dulceria/Direccion/producto_detalle2.dart';
import 'package:dulceria/Modelo/cajas_modelo2.dart';
                      ...
                      children: [
                        ...
                        Row(
                            ...
                            children:[
                              ...
                              Column(
                                children: [
                                  Text('Para recoger', style: TextStyle(color: Colors.purple[800],fontSize: 35, fontWeight: FontWeight.bold)),
                                  SizedBox(
                                      width: 350,
                                      child: Text(widget.product.nombreProducto, style: TextStyle(color: Colors.purple[800], fontSize: 25), textAlign: TextAlign.center)),
                                ],
                              )
                                  :
                              Column(
                                children: [
                                  Text('Tu pedido', style: TextStyle(color: Colors.purple[800],fontSize: 35, fontWeight: FontWeight.bold)),
                                  Text(widget.product.foto, style: TextStyle(color: Colors.purple[800],fontSize: 20)),
                                ],
                              ),
                        ...
                        Padding(
                          ...
                          child: Text(widget.product.codigoDeBarra, style: TextStyle(fontSize: 25, color: Colors.purple[800])),
                        )
                            :
                        Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text('Subtotal: ', style: TextStyle(color: Colors.purple[800], fontSize: 20.0),),
                                  subtotal(context),
                                ],
                              ),
                              SizedBox(height:10),
                              Row(
                                ...
                                children: [
                                  Text('Servicio A Dom.: ', style: TextStyle(color: Colors.purple[800], fontSize: 20.0),),
                              ...
                              Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children:[
                                    Text('Total: ', style: TextStyle(color: Colors.purple[800], fontSize: 40.0, fontWeight: FontWeight.bold),),
                                    total(context),
                                  ]
                              ),
                            ],
      ...
      child: Column(
        children: <Widget>[
          AlertDialog(
            ...
            title: Text("Reportar pedido a Dulceria", style: TextStyle(color: Colors.black)),
            content: Column(
