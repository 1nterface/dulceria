import 'package:dulceria/Direccion/alta_postres.dart';
...
class catalogo_postres extends StatefulWidget {

  cajas_modelo product;

  final int folio;
  catalogo_postres(this.folio, this.product);


  @override
  catalogo_postresState createState() => catalogo_postresState();
}

class catalogo_postresState extends State<catalogo_postres> {
  ...
  Widget lista (){
    ...
    return Expanded(
      child: StreamBuilder(
        ...
        //Y ASI  CON TODOS
          stream: reflistaproduccion.where('correoNegocio', isEqualTo: correo).where('categoria', isEqualTo: "Otros").orderBy('nombreProducto', descending: false).snapshots(),
        ...
        children: [
          ...
          SpeedDialChild(
              ...
              onTap: () async {
                ...
                await Navigator.push(context, MaterialPageRoute(builder: (context) => alta_postres(cajas_modelo("", widget.product.nombreProducto,"fecha",0,2,3, 0,5,"","Hombres","foto","descripcion", "newid", 0))),);
              }
          ),
          //  SpeedDialChild(
          //  child: Icon(Icons.add, color: Colors.white,),
