...
class bebidas_sheet extends StatefulWidget {

  int folio;

  bebidas_sheet(this.folio);

  @override
  _bebidas_sheetState createState() => _bebidas_sheetState();
}

class _bebidas_sheetState extends State<bebidas_sheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      ...
      //Y ASI  CON TODOS
        stream: reflistacajas.where('correoNegocio', isEqualTo: correoPersonal).where('categoria', isEqualTo: "Enchilosos").orderBy('nombreProducto', descending: false).snapshots(),
