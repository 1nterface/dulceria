...
class repartidores_direccion extends StatefulWidget {
  @override
  repartidores_direccionState createState() => repartidores_direccionState();
}

class repartidores_direccionState extends State<repartidores_direccion> {

  CollectionReference reflistaproduccion = FirebaseFirestore.instance.collection('Repartidor_Registro');
  ...
  void _borrarElemento (BuildContext context, String newid) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: Text('¿Deseas eliminar este repartidor?', style: TextStyle(color: Colors.black)),
          actions: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () {
                ...
                FirebaseFirestore.instance.collection('Repartidor_Registro').doc(newid).delete();
  ...
  Widget listaColonia (BuildContext context){
    ...
    return StreamBuilder(
      //Asi encontraremos los negocios por ciudad y sin problemas con la BD
        stream: reflistaproduccion.where('correoNegocio', isEqualTo: correoPersonal).orderBy('miembrodesde', descending: true).snapshots(),
                    ...
                    child: Stack(
                      children: <Widget>[
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text(documents["nombre"], textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.grey),)
                          ],
                        ),
                      ],
                    ),
...
class OnelookLogoBarra extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    AssetImage assetImage = AssetImage('images/dish.png');
