...
import 'alta_hogar.dart';

class catalogo_hogar extends StatefulWidget {

  cajas_modelo product;

  final int folio;
  catalogo_hogar(this.folio, this.product);


  @override
  catalogo_hogarState createState() => catalogo_hogarState();
}

class catalogo_hogarState extends State<catalogo_hogar> {
  ...
  Widget lista (){
    ...
    return Expanded(
      child: StreamBuilder(
        ...
        //Y ASI  CON TODOS
          stream: reflistaproduccion.where('correoNegocio', isEqualTo: correo).where('categoria', isEqualTo: "Hogar").orderBy('nombreProducto', descending: false).snapshots(),
        ...
        children: [
          ...
          SpeedDialChild(
              ...
              onTap: () async {
                ...
                await Navigator.push(context, MaterialPageRoute(builder: (context) => alta_hogar(cajas_modelo("", widget.product.nombreProducto,"fecha",0,2,3, 0,5,"","Hombres","foto","descripcion", "newid", 0))),);
              }
          ),
          //  SpeedDialChild(
