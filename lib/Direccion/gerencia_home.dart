...
import 'package:dulceria/Direccion/catalogo_hombres.dart' as pagos;
import 'package:dulceria/Direccion/catalogo_postres.dart' as postres;
import 'package:dulceria/Direccion/catalogo_mujeres.dart' as carpinteria;
import 'package:dulceria/Direccion/catalogo_hogar.dart' as hogar;
import 'package:dulceria/Direccion/catalogo_cipriana.dart' as cipriana;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Bienvenido a Dulceria", style: TextStyle(color: Colors.white)),
        bottom: TabBar(
