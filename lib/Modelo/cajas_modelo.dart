...
class cajas_modelo{
  ...
  cajas_modelo(this._id, this._nombreProducto, this._fecha,this._folio, this._maximo, this._minimo, this._precioVenta, this._existencia, this._codigoDeBarra, this._nombreProveedor, this._foto, this._estado, this._newid, this._costoProducto);
