import 'dart:math';
import 'package:dulceria/Clientes/compras_detalles.dart';
...
import 'package:dulceria/Modelo/panel_pedido_modelo.dart';
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text('Finalizo', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold),)
                              :
                          Text('Finalizo', style: TextStyle(color: Colors.red[800], fontWeight: FontWeight.bold),),
                          SizedBox(width: 20,),
                          Text(finalizo),
                        ],
                      ),
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        SizedBox(
                                          height: 50,
                                          width: 60,
                                          child: Icon(Icons.motorcycle, color: Colors.purple[900], size: 35,),
                                        ),
                                        Column(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          children: <Widget>[
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            ...
                                            SizedBox(
                                                width: 120,
                                                child: Text(documents["estado3"], textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.purple[800]),)),
                                        ...
                                        SizedBox(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              SizedBox(height: 10,),
                                              Text("Tiempo "+32.toString()+" | "+documents["hora"],
                                                  maxLines: 1,
                                                  overflow: TextOverflow.fade,
                                                  softWrap: false,
                                              ...
                                              Container()
                                                  :
                                              Text(documents["repa"], style: TextStyle(color: Colors.purple[800]), maxLines: 1, overflow: TextOverflow.fade, softWrap: false),
                                            ],
                                          ),
                                        ),
                                      ],
