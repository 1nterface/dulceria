...
import 'package:dulceria/Clientes/como_quieres_pagar.dart';
//import 'package:repartamos/Clientes/Como_Quieres_Pagar2.dart';
import 'package:dulceria/Modelo/agentes_modelo.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Pago Dulceria', style: TextStyle(color: Colors.white)),
      ),
      body: Padding(
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            InkWell(
                              ...
                              child: Icon(Icons.restore_from_trash, color: Colors.red[800]),
                            ),
                          ],
                        ),
