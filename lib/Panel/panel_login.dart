...
import 'package:dulceria/Panel/lista_afiliados.dart';
import 'package:dulceria/Panel/panel_de_control.dart';
import 'package:dulceria/authentication.dart';
...
class panel_login extends StatefulWidget {

  var data;
  panel_login({this.data});
  @override
  panel_loginState createState() => panel_loginState();
}

class panel_loginState extends State<panel_login> {
    ...
    AuthenticationHelper()
      ...
      if (result == null) {
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) => lista_afiliados()));
      } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          centerTitle: true,
          title: Text('Panel Dulceria', style: TextStyle(color: Colors.white),)
      ),
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              alignment: Alignment.bottomRight, //Aqui se indica la posicion en la pantalla
                                ...
                                child: Text('REGISTRARME', style: TextStyle(color: Colors.purple[800], fontSize: 20, fontWeight: FontWeight.bold),),
                              onTap: (){

                                Toast.show("Contactar a Soporte Tecnico", context, duration: Toast.LENGTH_LONG, gravity:  Toast.CENTER);

                                Navigator.of(context).pushNamed('/panel_registro');
