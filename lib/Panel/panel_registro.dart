...
class panel_registro extends StatefulWidget {
  ...
  const panel_registro({required Key key, required this.permissionLevel}) : super(key: key);
...
class panel_registroState extends State<panel_registro> {
  ...
  Future _startUploadTask() async {
    ...
    final collRef = FirebaseFirestore.instance.collection('Panel_Registro').doc(_userEmail);
    ...
    FirebaseFirestore.instance.collection('Notificaciones').doc("Compras"+correoPersonal.toString()).set({'notificacion': "0"});
    FirebaseFirestore.instance.collection('Notificaciones').doc("Pedidos_Jimena_Interna"+correoPersonal.toString()).set({'notificacion': '0'});
    FirebaseFirestore.instance.collection('Notificaciones').doc("Carrito"+correoPersonal.toString()).set({'notificacion': '0'});
